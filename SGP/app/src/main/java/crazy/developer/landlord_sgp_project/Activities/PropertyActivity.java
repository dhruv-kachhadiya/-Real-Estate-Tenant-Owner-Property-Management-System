...
public class PropertyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog =new ProgressDialog(PropertyActivity.this);
        myRef = FirebaseDatabase.getInstance().getReference().child("users");
        property_list = FirebaseDatabase.getInstance().getReference().child("property_list");
    ...
    private void updateDialogBox(final String propertyID, final String propertyLocation){
        ...
        Query queryLocation = mFirebaseRef.child("users").child(userID).child("own").child(propertyID);
        ...
        Query queryRental = mFirebaseRef.child("users").child(userID).child("own").child(propertyID);
        ...
        Query queryAddress = mFirebaseRef.child("users").child(userID).child("own").child(propertyID);
        ...
        Query queryPostcode = mFirebaseRef.child("users").child(userID).child("own").child(propertyID);
        ...
        Query queryTenancyLength = mFirebaseRef.child("users").child(userID).child("own").child(propertyID);
        ...
        Query queryTenantName = mFirebaseRef.child("users").child(userID).child("own").child(propertyID);
        ...
        Query queryManagementName = mFirebaseRef.child("users").child(userID).child("own").child(propertyID);
        ...
        Query queryBedrooms = mFirebaseRef.child("users").child(userID).child("own").child(propertyID);
        ...
        Query queryRefurb = mFirebaseRef.child("users").child(userID).child("own").child(propertyID);
    ...
    private void deleteProperties(String propertyID){
        DatabaseReference drProperties = FirebaseDatabase.getInstance().getReference("users").child(userID).child("own").child(propertyID);
        DatabaseReference drProperties1 = FirebaseDatabase.getInstance().getReference("property_list").child(propertyID);
    ...
    private boolean updateProperties (String id, String location, String address, String postcode, String type, String bedrooms, String rent, String t_length, String t_name, String m_name, String refurb){
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("users").child(userID).child("own").child(id);
        DatabaseReference databaseReference1 = FirebaseDatabase.getInstance().getReference("property_list").child(id);
        ...
        databaseReference1.setValue(properties);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(location) && !TextUtils.isEmpty(address) && !TextUtils.isEmpty(postcode)){
                    ...
                    String id1 = property_list.push().getKey();

                    Properties properties = new Properties(id, location, address, postcode, type, bedrooms, rent, t_length, t_name, m_name, refurb);

                    myRef.child(userID).child("own").child(id).setValue(properties);
                    property_list.child(id1).setValue(properties);
    ...
    public void onStart() {
        ...
        FirebaseDatabase.getInstance().getReference("users").getRef().child(userID).child("own").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
