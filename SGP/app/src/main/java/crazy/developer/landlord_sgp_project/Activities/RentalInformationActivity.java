...
public class RentalInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog_imageview=findViewById(R.id.dialog_ImageView);
        text_view_h0=findViewById(R.id.text_view_h0);
        text_view_h1=findViewById(R.id.text_view_h1);
        text_view_h2=findViewById(R.id.text_view_h2);
        text_view_h3=findViewById(R.id.text_view_h3);
        text_view_h4=findViewById(R.id.text_view_h4);
        text_view_h5=findViewById(R.id.text_view_h5);


         String Rent=getIntent().getExtras().get("R").toString();
         String Type=getIntent().getExtras().get("T").toString();
         String Location=getIntent().getExtras().get("L").toString();
         String Name=getIntent().getExtras().get("N").toString();
         String Phone=getIntent().getExtras().get("P").toString();
         String Email=getIntent().getExtras().get("E").toString();

         text_view_h0.setText("Rent :"+Rent);
         text_view_h1.setText("Type :"+Type);
         text_view_h2.setText("Location :"+Location);
         text_view_h3.setText("Name :"+Name);
         text_view_h4.setText("Phone :"+Phone);
         text_view_h5.setText("Email :"+Email);

        Picasso.with(this).load(imgURL).placeholder(R.drawable.rent_dummy).fit().centerCrop().into(dialog_imageview);
